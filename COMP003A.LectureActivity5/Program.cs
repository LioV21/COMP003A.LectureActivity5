    ...
    namespace COMP003A.LectureActivity5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            HelloWorld("Alan Turing", DataTime.Now.Year - 1912); // call to HelloWorld (string name, int inputAge), which is an overloaded method
            HelloWorld("Ada Lovelace", DataTime.Now.Year - 1815); // call to HelloWorld(string name, int inputAge) again 
            HelloWorld("Charles Babbage", DataTime.Now.Year - 1791); // call to HelloWorld(string name, int inputAge) again
            ...
            // call to Sum(decimal num1, decimal num2) and storing the return vvalue in a variable 
            decimal sum = Add(inputNumber1, inputNumber2);
            Console.WriteLine($"Summation: {sum}"); // output the value of sum to console 

            // if you don't plan on using a vvariable, you can simplify the method call like the lines below
            ...
            * is you type '///' on top of a class or methor,
            ...
            * <summary></summary> usedd to decribe a type  member
            * <param name=" nameOfTheParameter"></param> used for descrbing one or more parameters in the method signature 
            * <returns></returns> use to describe the return value 
            * 
            * there are other tags in https://leanr.microsoft.com/en-us/dotnet/csharp/language-reference/xmldoc/recommended-tags
            */

            //NOTE: Method definitions are programmed insede the class { } code block, not inside Main() { }

            /// <summary>
            /// Mehtod without parameters and return values
            ///</summary>
            ...
            /// </summary >
            /// <param name="inputName">StringInput</param>
